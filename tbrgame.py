...
class TextAdventureCmd(cmd.Cmd):
    ...
    # The default() method is called when none of the other do*() command methods match.
    ...
    def do_take(selfself, arg):
        ...
        if itemToTake == '':
            print('Take what? Type "look" to view the items on the ground here.')
            return
    ...
    def complete_drop(self, text, line, begidx, endidx):
        ...
        for descWord in invDescWords:
            ...
            # otherwise, get a list of all "description words" for inventory items matching the command so far
            for descWord in invDescWords:
